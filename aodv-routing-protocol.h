...
private:
  ...
  /// Raw subnet directed broadcast socket per each IP interface, map socket -> iface address (IP + mask) added. CNLAB
...
private:
  ...
  */
  ...
  /// Find subnet directed broadcast socket with local interface address iface. added. CNLAB
